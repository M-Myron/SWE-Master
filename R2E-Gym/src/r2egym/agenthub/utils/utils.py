...
try:
    # HfFolder was removed in huggingface_hub>=0.33; it is unused here but kept
    # importable so older callers don't break. Guard so modern hubs (shipped in
    # the vLLM serving image) don't crash this module at import time.
