...
DOCKER_TLS_VERIFY = ""
DOCKER_CERT_PATH = "" # Path for PEM storage; optional and can be removed if not needed.
        ...
        if self.swebench_verified:
            ...
            if "make_test_spec" in self.ds:
                ...
                if check_cache_exists(self.cache_file):
                    ...
                    self.logger.info(f"load from github")
                    from swebench.harness.test_spec.test_spec import make_test_spec as _mk_test_spec
                    self.test_spec = _mk_test_spec(self.ds)
